...
#include "GDEffekseer.Shader.h"
#include "GDEffekseer.VertexBuffer.h"
#include "GDEffekseer.ModelRenderer.h"
...
GDEffekseer::RenderCommand2D::RenderCommand2D()
{
	auto vs = godot::VisualServer::get_singleton();
...
void GDEffekseer::RenderCommand2D::Reset()
{
	auto vs = godot::VisualServer::get_singleton();
...
void GDEffekseer::RenderCommand2D::DrawSprites(godot::Node2D* parent)
{
	auto vs = godot::VisualServer::get_singleton();
...
bool RendererImplemented::Initialize(int32_t drawMaxCount)
{
	...
	}
	{
		...
		using namespace GDEffekseer::StandardShaders;
...
void RendererImplemented::DrawSprites(int32_t spriteCount, int32_t vertexOffset)
{
	...
	if (auto emitter = godot::Object::cast_to<godot::EffekseerEmitter>(godotObj)) {
		...
		// Transfer vertex data
		auto srt = GDEffekseer::ToSRT(emitter->get_global_transform());
