...
#else // ! USE_D3D9EX
LPDIRECT3D9EX sD3D;
LPDIRECT3DDEVICE9EX sD3DDevice;
#endif // ! USE_D3D9EX
...
void SaveBackbuffer(LPDIRECT3DSURFACE9 surface)
{
    D3DXSaveSurfaceToFileW(L"temp", D3DXIFF_PNG, surface, NULL, NULL);

    //D3DLOCKED_RECT sRect;
    //surface->LockRect(&sRect, NULL, D3DLOCK_NO_DIRTY_UPDATE);
    //void* bmpbuffer = sRect.pBits;
    //surface->UnlockRect();
}
...
D3DInit(void)
{
...
#else // ! USE_D3D9EX
  Direct3DCreate9Ex(D3D_SDK_VERSION, &sD3D);
#endif // ! USE_D3D9EX
  ...
  hr = sD3D->CreateDevice(D3DADAPTER_DEFAULT,
                          ...
                          &sD3DDevice);
#else //  ! USE_D3D9EX
  hr = sD3D->CreateDeviceEx(D3DADAPTER_DEFAULT,
                            D3DDEVTYPE_HAL,
                            sHwnd,
                            D3DCREATE_FPU_PRESERVE | D3DCREATE_MULTITHREADED | D3DCREATE_HARDWARE_VERTEXPROCESSING,
                            &sD3Dpp,
...
#if USE_D3D9EX
  sEmoteDevice->SetUseD3D9Ex(true);
#endif // USE_D3D9EX
